                ...
                <div className="grid grid-cols-4 gap-5 max-sm:grid-cols-1">
                    {perpetuals.length > 0 && perpetuals.map((perpetual: any) => <SmallWhiteCard key={perpetual.id}>
                        ...
                        <div className="items-end pb-2">
                            {perpetual.attributes.happened ? <RedTitle fristLine={perpetual.attributes.person_name}
                                SecondLine={perpetual.attributes.model} /> : perpetual.attributes.reason_of_not_happaned}
                        </div>
